...
```bash
uv add git+https://github.com/kthota-g/ard-client
```
...
### 6. 🤗 Real-world Dynamic Search (Hugging Face)
Query the public Hugging Face Agent Finder registry directly to run semantic queries.
...
async def main():
    # Initialize ArdClient directly with the Hugging Face Agent Finder registry URL
